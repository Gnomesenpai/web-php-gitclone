...
RUN apt-get update && apt-get dist-upgrade -y && apt-get install wget gpg git curl lsb-release apt-transport-https ca-certificates -y \
    && wget -O -q /etc/apt/trusted.gpg.d/php.gpg https://packages.sury.org/php/apt.gpg && \
